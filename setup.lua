...
function setup.config()
    ...
    --Regular images
    IMG_SETUP_GOAL = love.graphics.newImage("assets/goal_setup_img.png")
    IMG_SETUP_NP   = love.graphics.newImage("assets/default_img.png")
    ...
    font_reg_mss = love.graphics.newFont( "assets/FUTUVA.ttf", 20) --Font for regular text, medium size
